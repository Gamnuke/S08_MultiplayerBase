...
#include "S08_NetworkingCourse/MenuSystem/InGameUI/ChatSystem/ChatDisplayWidget.h"
...
void AMainCharacter::BeginPlay()
{
	...
	if (GetPlayerState() != nullptr) {
		Server_CreateChatDisplay(FText::FromString(GetPlayerState()->GetPlayerName()), FText(), AssignedColor);
	}
}
